...
export PYTHON3_VERSION_MAX=14
export PYTHON3_VERSION_RANGE=$(seq "${PYTHON3_VERSION_MIN}" 1 "${PYTHON3_VERSION_MAX}")
export GHC_VERSION=9.2.8
export CABAL_VERSION=3.6.2.0
export ALPINE_VERSION_DUCKLING_FFI=3.18
export ALPINE_VERSION_PYDUCKLING=3.21
export MATURIN_VERSION=1.12.6
export IMAGE_PREFIX="ghcr.io/phihos/pyduckling"
export BUILD_IMAGE_DUCKLING_FFI=$IMAGE_PREFIX/duckling-ffi-build:alpine-${ALPINE_VERSION_DUCKLING_FFI}-ghc-${GHC_VERSION}
